...
from myapp.utils import decimal_to_number
...
class Dynamodb(object):
    ...
    def get_connection(self):
        ...
        if self._connection is None:
            extra_args = app_config.get('dynamodb', {}).get('extra.args', {})
    ...
    def batch_get_items(self, table_name, keys, projection_expression=None, expression_attribute_names=None, decimal_factory=decimal_to_number):
        ...
        while len(keys) > 0:
            ...
            res = conn.batch_get_item(RequestItems=req)
